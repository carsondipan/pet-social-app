    ...
    return (
        <body class="bg-gray-50">
            <header class=" bg-white shadow border-b">
                <div
                    class="flex justify-between lg:block px-4 py-3 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8"
                >
                    <div class=" grid grid-cols-12 items-center">
                        <div class="col-span-6 lg:col-span-3">
                            ...
                            >
                                ...
                                <span
                                    class="ml-2 text-2xl font-bold tracking-widest text-blue-600 uppercase"
                                >sockitX</span
                                >
                            </a>
                        </div>
                        ...
                        <div class="hidden lg:block lg:col-span-6">
                            <ul
                                class="flex items-center justify-center hidden space-x-8 lg:flex"
                            >
                                <li>
                                    <a
                                        href="#"
                                        class="block hover:bg-gray-100 rounded-lg font-medium tracking-wide text-gray-900 hover:text-teal-accent-400 p-5"
                                    >
                                        <svg
                                ...
                                <li>
                                    ...
                                    >
                                        <div class="relative">
                                            <div
                                                class="absolute top-0 right-0 w-3 h-3 text-white rounded-full bg-red-600 text-xs text-center"
                                            ></div>
                                            <svg
                                                class="h-6 w-6 text-blue-600"
                                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div
                            class="hidden col-span-6 lg:col-span-3 sm:flex justify-end"
                        >
                            <div
                                class="flex items-center bg-gray-200 p-2  justify-end rounded-lg"
                            >
                                <svg
                                    class="text-gray-700"
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <input
                                    ...
                                    type="text"
                                    class="ml-2 focus:outline-none bg-transparent border-0 focus:border-0 focus:ring-0"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:hidden">
                        ...
                        <div class="absolute top-0 left-0 w-full">
                            <div class="p-5 bg-white border rounded shadow-sm">
                                ...
                                <nav>
                                    <ul class="space-y-4">
                                        <li><a href="/" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Dashboard</a></li>
                                        <li><a href="/" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Friends</a></li>
                                        <li><a href="/" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Notifications</a></li>
                                        <li><a href="/" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Messages</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
