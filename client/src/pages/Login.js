    ...
    return (
      <section class="bg-teal-20 dark:bg-teal-20">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-min lg:py-0">
          ...
          <div class="w-full bg-teal-600 rounded-lg shadow dark:border-teal-700 mb-4 md:mt-0 sm:max-w-md xl:p-0 dark:bg-teal-600 dark:border-teal-700">
              ...
              <form onSubmit={handleFormSubmit} class="space-y-4 md:space-y-6" action="#">
                ...
                <div>
                  ...
                  <input type="password" name="password" id="password"
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    class="bg-teal-50 border border-teal-600 text-teal-900 placeholder-teal-500 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-teal-50 dark:border-teal-600 dark:placeholder-teal-500 dark:text-teal-900 dark:focus:ring-blue-600 dark:focus:border-blue-600" required="true" />
                </div>
                <button type="submit" class="w-full text-white bg-sky-700 hover:bg-teal-400 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
                <p class="text-sm font-light text-teal-300 dark:text-teal-300">
                  Don’t have an account yet? <a href="/signup" class="font-medium text-primary-500 hover:underline dark:text-primary-500 hover:text-teal-100">Sign up!</a>
                </p>
              </form>
            </div>
          </div>
