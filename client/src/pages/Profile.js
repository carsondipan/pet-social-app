      ...
      <div class="p-16 bg-teal-50">
        <div class="p-8 bg-white shadow mt-24">
          ...
          <div class="mt-20 text-center border-b pb-12">
            ...
            <p class="mt-8 text-gray-500"># of pets</p>
          </div>
        ...
        <div className="flex flex-col justify-center max-w-xs mt-6 p-6 shadow-md rounded-xl sm:px-12 dark:bg-white dark:text-gray-100">
          ...
          <div className="space-y-4 text-center divide-y divide-gray-700">
            <div className="my-2 space-y-1">
              <h2 className="text-xl font-semibold sm:text-2xl dark:text-teal-600">PET NAME</h2>
              <p className="px-5 text-xs sm:text-base dark:text-gray-400">PET TYPE</p>
            </div>
