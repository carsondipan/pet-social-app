  ...
  if (Auth.loggedIn()) {
    return (
      <>
        <nav class="bg-white border-teal-200 dark:bg-teal-900">
          <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
            <Link to="/" class="flex items-center">
              <img src="./PetbookLogo.png" class="h-6 mr-3 sm:h-9" alt="Petbook Logo" />
            </Link>
            ...
            <div class="flex md:order-2">
              ...
              <div class="pl-6 pt-2 relative hidden md:block">
                <Link to="/me" class="text-sm mx-2 p-2 font-medium text-cyan-500 dark:text-white rounded bg-cyan-600 hover:bg-cyan-700">Profile</Link>
                <Link to="/signup"><button onClick={logout} class="text-sm mx-2 p-1.5 font-medium text-cyan-400 dark:text-white rounded bg-cyan-700 hover:bg-cyan-900">
                  Log out
                </button></Link>
              </div>
        ...
        <nav class="bg-teal-50 dark:bg-teal-700">
          <div class="max-w-screen-xl px-4 py-3 mx-auto md:px-6">
            <div class="flex items-center">
              <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium text-teal-300">
                <li><a href="" class="hover:text-teal-100">New Posts</a></li>
                <li><a href="" class="hover:text-teal-100">Top Posts</a></li>
                <li><a href="" class="hover:text-teal-100">Users</a></li>
              </ul>
            </div>
          </div>
        </nav>
        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
          ...
          <div class="flex md:order-2">
            ...
            <div class="relative hidden md:block">
              ...
              <input type="text" id="search-navbar" class="block w-full p-2 pl-10 text-sm text-teal-900 border border-teal-300 rounded-lg bg-teal-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-teal-700 dark:border-teal-600 dark:placeholder-teal-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
            </div>
            ...
            <div class="pl-6 pt-2 relative hidden md:block">
              <Link to="/login" class="text-sm mx-2 p-2 font-medium text-cyan-500 dark:text-white rounded bg-cyan-600 hover:bg-cyan-700">Login</Link>
              <Link to="/signup" class="text-sm mx-2 p-2 font-medium text-cyan-400 dark:text-white rounded bg-cyan-700 hover:bg-cyan-900">Signup</Link>
            </div>
