...
const Footer = () => {
  return (
    ...
    <footer class="p-4 bg-white shadow md:px-6 md:py-8 dark:bg-teal-900">
      <div class="sm:flex sm:items-center sm:justify-between">
        <Link to="/" class="flex items-center mb-4 sm:mb-0">
          <img src="./PetbookLogo.png" class="h-8 mr-3" alt="Petbook Logo" />
        </Link>
        <ul class="flex flex-wrap items-center mb-6 text-sm text-teal-800 sm:mb-0 dark:text-teal-600">
          <li>
      ...
      <hr class="my-6 border-teal-600 sm:mx-auto dark:border-teal-700 lg:my-8" />
